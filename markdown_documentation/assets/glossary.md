...
{{newglossaryentry(key-value pair)
{
    type={general},
    name={key-value pair},
...
{{newglossaryentry(response document)
{
    type={general},
...
{{newglossaryentry(specification limit)
{
    type={general},
...
{{newglossaryentry(equipment metadata)
{
    type={industrial},
