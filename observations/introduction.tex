...
\begin{itemize}
    \item Note: \citetitle{MTCPart5} provides details on extensions to the \gls{Observation Information Model} required to describe the interactions between pieces of equipment.
