...
* Note 2 to Entry: A singular \property{assetId}[Asset] uniquely identifies an \gls{MTConnect Asset} throughout its lifecycle and is used to track and relate the \gls{MTConnect Asset} to other \glspl{MTConnect Device} and entities.
