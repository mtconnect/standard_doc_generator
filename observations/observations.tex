...
Within each \block{ComponentStream} container in the \block{MTConnectStreams} document, \glspl{Data Entity} are organized into three types of container elements - \block{Samples}, \block{Events}, and \block{Conditions}.  (See \sect{DataItem Types} for more information on these elements.)
