...
\begin{itemize}
\item \block{MTConnectDevices} document: \gls{Data Entity} elements define the data that may be returned from a piece of equipment.  \citetitle{MTCPart2}, \textit{Sections 7 and 8} lists the possible \gls{Data Entity} \gls{XML} elements that can be returned in a \block{MTConnectDevices} document.  
