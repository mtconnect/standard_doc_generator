...
The \property{type} and \property{subType} (where applicable) attributes for a \block{Condition} element \textbf{MAY} be any of the \property{type} and \property{subType} attributes defined for \texttt{SAMPLE} \property{category} or \texttt{EVENT} \property{category} \block{DataItem} listed in the \gls{Device Information Model}.
