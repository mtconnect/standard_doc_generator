...
**DEPRECATED** in Version 1.2.  See \block{FILL_LEVEL}
...
Subtypes of PathPosition are: \texttt{ACTUAL}, \texttt{COMMANDED}, \texttt{PROBE}, \texttt{TARGET} and \texttt{TARGET}. 
\FloatBarrier
...
**DEPRECATED** in Version 1.2.  Replaced by \block{ROTARY_VELOCITY}
