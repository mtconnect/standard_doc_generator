...
\FloatBarrier
\subsubsection[Application]{Application \\ {\small Subtype of Event}}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of Application}}
  \label{properties:Application}
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Property} & {Value} \\
...
\FloatBarrier
 ...
 Enumerated \texttt{type}s for \texttt{Application} are:
\begin{itemize}
...
\begin{itemize}
\item \texttt{InstallDateApplication} : The date the hardware or software was installed.

\item \texttt{LicenseApplication} : The license code to validate or activate the hardware or software.

\item \texttt{ManufacturerApplication} : The corporate identity for the maker of the hardware or software.

\item \texttt{ReleaseDateApplication} : The date the hardware or software was released for general use.

\item \texttt{VersionApplication} : The version of the hardware or software.
...
\FloatBarrier
\FloatBarrier
\subsubsection[Firmware]{Firmware \\ {\small Subtype of Event}}
  \label{type:Firmware}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of Firmware}}
  \label{properties:Firmware}
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Property} & {Value} \\
...
\FloatBarrier
 ...
 Enumerated \texttt{type}s for \texttt{Firmware} are:
\begin{itemize}
...
\begin{itemize}
\item \texttt{InstallDateFirmware} : The date the hardware or software was installed.

\item \texttt{LicenseFirmware} : The license code to validate or activate the hardware or software.

\item \texttt{ManufacturerFirmware} : The corporate identity for the maker of the hardware or software.

\item \texttt{ReleaseDateFirmware} : The date the hardware or software was released for general use.

\item \texttt{VersionFirmware} : The version of the hardware or software.
...
\FloatBarrier
\subsubsection[Hardware]{Hardware \\ {\small Subtype of Event}}
  \label{type:Hardware}
...
\FloatBarrier
 ...
 Enumerated \texttt{type}s for \texttt{Hardware} are:
\begin{itemize}
...
\begin{itemize}
\item \texttt{InstallDateHardware} : The date the hardware or software was installed.

\item \texttt{LicenseHardware} : The license code to validate or activate the hardware or software.

\item \texttt{ManufacturerHardware} : The corporate identity for the maker of the hardware or software.

\item \texttt{ReleaseDateHardware} : The date the hardware or software was released for general use.

\item \texttt{VersionHardware} : The version of the hardware or software.
...
\FloatBarrier
\FloatBarrier
\subsubsection[Library]{Library \\ {\small Subtype of Event}}
  \label{type:Library}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of Library}}
  \label{properties:Library}
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Property} & {Value} \\
...
\FloatBarrier
 ...
 Enumerated \texttt{type}s for \texttt{Library} are:
\begin{itemize}
...
\begin{itemize}
\item \texttt{InstallDateLibrary} : The date the hardware or software was installed.

\item \texttt{LicenseLibrary} : The license code to validate or activate the hardware or software.

\item \texttt{ManufacturerLibrary} : The corporate identity for the maker of the hardware or software.

\item \texttt{ReleaseDateLibrary} : The date the hardware or software was released for general use.

\item \texttt{VersionLibrary} : The version of the hardware or software.
...
\FloatBarrier
\subsubsection[Network]{Network \\ {\small Subtype of Event}}
  \label{type:Network}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of Network}}
  \label{properties:Network}
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Property} & {Value} \\
...
\FloatBarrier
 ...
 Enumerated \texttt{type}s for \texttt{Network} are:
\begin{itemize}
...
\begin{itemize}
\item \texttt{GatewayNetwork} : The Gateway for the component network.

\item \texttt{IPv4AddressNetwork} : The IPV4 network address of the component.

\item \texttt{IPv6AddressNetwork} : The IPV6 network address of the component.

\item \texttt{MacAddressNetwork} : Media Access Control Address. The unique physical address of the network hardware.

\item \texttt{SubnetMaskNetwork} : The SubNet mask for the component network.

\item \texttt{VLanIdNetwork} : The layer2 Virtual Local Network (VLAN) ID for the component network.

\item \texttt{WirelessNetwork} : Identifies whether the connection type is wireless.
...
\FloatBarrier
\subsubsection[OperatingSystem]{OperatingSystem \\ {\small Subtype of Event}}
  \label{type:OperatingSystem}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of OperatingSystem}}
  \label{properties:OperatingSystem}
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Property} & {Value} \\
...
\FloatBarrier
 ...
 Enumerated \texttt{type}s for \texttt{OperatingSystem} are:
\begin{itemize}

\end{itemize}

Subtypes of \texttt{OperatingSystem} are :

\begin{itemize}
\item \texttt{InstallDateOperatingSystem} : The date the hardware or software was installed.

\item \texttt{LicenseOperatingSystem} : The license code to validate or activate the hardware or software.

\item \texttt{ManufacturerOperatingSystem} : The corporate identity for the maker of the hardware or software.

\item \texttt{ReleaseDateOperatingSystem} : The date the hardware or software was released for general use.

\item \texttt{VersionOperatingSystem} : The version of the hardware or software.
...
\begin{itemize}
\item \texttt{ALL} : The number of parts produced. 

\item \texttt{BAD} : The number of parts produced that do not conform to specification.

\item \texttt{GOOD} : The number of parts produced that conform to specification.

\item \texttt{REMAINING} : The number of remaining or in-stock parts to be produced.

\item \texttt{TARGET} : The number of projected or planned parts to be produced.
...
Subtypes of \texttt{ProgramHeader} are :
...
\FloatBarrier
\subsubsection[Rotation]{Rotation \\ {\small Subtype of Event}}
  \label{type:Rotation}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of Rotation}}
  \label{properties:Rotation}
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Property} & {Value} \\
...
\FloatBarrier
 ...
 Enumerated \texttt{type}s for \texttt{Rotation} are:
\begin{itemize}
...
\FloatBarrier
\subsubsection[Translation]{Translation \\ {\small Subtype of Event}}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of Translation}}
...
\FloatBarrier
 ...
 Enumerated \texttt{type}s for \texttt{Translation} are:
\begin{itemize}
