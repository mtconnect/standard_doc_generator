...
\block{ComponentRef} is a pointer to all of the information associated with another \gls{Structural Element} defined for a piece of equipment.  \block{ComponentRef} allows all of the information (\gls{Lower Level} \block{Components} and all \gls{Data Entities}) that is associated with the other \gls{Structural Element} to be directly associated with this element.
