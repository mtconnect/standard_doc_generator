...
\block{Constraints} \gls{organizes} a set of expected values that can be reported for this \block{DataItem}.
...
\begin{itemize}
\item \texttt{CellDefinitions} : \block{CellDefinitions} \gls{organizes} \block{CellDefinition} elements.
\item \texttt{Description} : An element that can contain any descriptive content.
\item \texttt{EntryDefinitions} : \block{EntryDefinitions} \gls{organizes} \block{EntryDefinition} elements.
\end{itemize}
\FloatBarrier
