...
A \block{Device} is a \block{Component} that represents a piece of equipment that produces \gls{observations} about itself. It \gls{organizes} its parts as \block{Components}.
