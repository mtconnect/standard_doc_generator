...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of CellDefinition}}
  \label{properties:CellDefinition}
\tabulinesep=3pt
...
\texttt{units} & \texttt{UnitEnum} & 0..1 \\
\texttt{DataItems} & \texttt{Component} & 1 \\
...
\texttt{hasTableDefinition} & \texttt{TableDefinition} & 0..1 \\
\end{tabu}
\end{table}
\FloatBarrier
...
\paragraph{\texttt{hasTableDefinition}}\mbox{}
\newline\tab Placeholder for documentation!
\FloatBarrier
...
\newline\tab Placeholder for documentation!
\FloatBarrier
\subsubsection{TableDefinition}
  \label{type:TableDefinition}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{Properties of TableDefinition}}
  \label{properties:TableDefinition}
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Property} & {Type} & {Multiplicity} \\
\tabucline[1.5pt]{}
\texttt{hasCellDefinition} & \texttt{CellDefinition} & 1..* \\
\texttt{Description} & \texttt{Description} & 0..1 \\
\end{tabu}
\end{table}
\FloatBarrier
...
\paragraph{\texttt{hasCellDefinition}}\mbox{}
\newline\tab Placeholder for documentation!
