...
When \block{Sensor} represents multiple \gls{sensing elements}, each \gls{sensing element} is represented by a \block{Channel} for the \block{Sensor}. 
...
\item \texttt{Channels} : \block{Channels} \gls{organizes} \block{Channel} elements.
