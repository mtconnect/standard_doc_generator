...
\property{sampleRate}[Component] & \texttt{float} & 0..1 \\
\property{uuid}[Component] & \texttt{ID} & 0..1 \\
\property{coordinateSystemIdRef}[Component] & \texttt{IDREF} & 0..1 \\
\end{tabu}
\end{table}
\FloatBarrier
...
\item \property{coordinateSystemIdRef}[Component] \newline Specifies the \block{CoordinateSystem} for this \block{Component} and its children.
\end{itemize}
