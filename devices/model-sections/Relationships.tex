...
\gls{href} is of type \cfont{xlink:href} from the W3C XLink specification: (https://www.w3.org/TR/xlink11/).
...
\hline
\endhead
\texttt{SYSTEM} & The associated element performs the functions of a \cfont{System} for this element. \\ \hline
\texttt{AUXILIARY} & The associated element performs the functions as an \cfont{Auxiliary} for this element. \\ \hline
\end{longtabu}
\FloatBarrier
\item \texttt{xlink:type} : The XLink \cfont{type} attribute \MUST have a fixed value of \cfont{locator} as defined in W3C XLink 1.1 https://www.w3.org/TR/xlink11/ \textit{section 5.4 Locator Attribute (\gls{href})}.
...
\gls{relationships} \glspl{organize} \gls{relationship} elements.
