...
This section provides semantic definition for the \block{Relationships} model.
...
Note: See \fig{Relationships Schema Diagram} for XML schema.
...
\property{idRef}[ComponentRelationship] & \texttt{IDREF} & 1 \\
\property{criticality}[ComponentRelationship] & \texttt{CriticalityTypeEnum} & 0..1 \\
\property{id}[ComponentRelationship] & \texttt{ID} & 1 \\
\property{type}[ComponentRelationship] & \texttt{RelationshipTypeEnum} & 1 \\
\end{tabu}
\end{table}
\FloatBarrier
...
\texttt{CriticalityTypeEnum} Enumeration:
...
\texttt{RelationshipTypeEnum} Enumeration:
...
\property{deviceUuidRef}[DeviceRelationship] & \texttt{IDREF} & 1 \\
\property{href}[DeviceRelationship] & \texttt{xlinkhref} & 0..1 \\
\property{role}[DeviceRelationship] & \texttt{RoleTypeEnum} & 0..1 \\
\property{xlink:type}[DeviceRelationship] & \texttt{xlinktype} & 0..1 \\
\property{criticality}[DeviceRelationship] & \texttt{CriticalityTypeEnum} & 0..1 \\
\property{id}[DeviceRelationship] & \texttt{ID} & 1 \\
\property{type}[DeviceRelationship] & \texttt{RelationshipTypeEnum} & 1 \\
\end{tabu}
\end{table}
\FloatBarrier
...
\texttt{RoleTypeEnum} Enumeration:
