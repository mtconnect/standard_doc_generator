...
\docnum{Part 4.0}							% Document "number"
\doctitle{Assets Information Model}	% Full document title
\doctitleshort{Assets Information Model}				% Shortened document title
\versionnum{1.7}						% MTConnect version
