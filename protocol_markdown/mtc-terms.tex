...
\longnewglossaryentry{mtconnect asset}
{
  name={MTConnect Asset}
}
{
  An \gls{mtconnect asset} is an \gls{asset} used by the manufacturing process to perform tasks.
...
\newglossaryentry{pressure sample}
{
  ...
  description={The force per unit area measured relative to atmospheric pressure.},
  units=\cfont{\gls{pascal}},
  kind={type,sample},
  facet={\gls{float}}
}

\newglossaryentry{pressureabsolute sample}
{
  type=mtc,
  category=model,
  name={PRESSURE\_ABSOLUTE},
  elementname=\cfont{PressureAbsolute},
  description={The force per unit area measured relative to a vacuum.},
  units=\cfont{\gls{pascal}},
  kind={type,sample},
  facet={\gls{float}}
}
...
{
	A \gls{response document} published by an \gls{mtconnect agent} in response to an \gls{asset request}.
}
...
\newglossaryentry{processes}
{
  type=mtc,
  category=model,
  name={Processes},
  kind={component},
  description={\gls{processes} \glspl{organize} information describing the manufacturing process being executed on a piece of equipment.}
}
...
\newglossaryentry{pressurizationrate sample}
{
  type=mtc,
  category=model,
  name={PRESSURIZATION\_RATE},
  elementname=\cfont{PressurizationRate},
  kind={sample,type},
...
\newglossaryentry{upperlimit key}
{
  ...
  category=model,
  name={UPPER\_LIMIT},
  description={\glsentrydesc{upper limit term}},
  kind={key}
}
...
\newglossaryentry{lowerlimit key}
{
  ...
  category=model,
  name={LOWER\_LIMIT},
  description={\glsentrydesc{lower limit term}},
  kind={key}
}
...
\newglossaryentry{nominal key}
{
  ...
  category=model,
  name={NOMINAL},
  description={\glsentrydesc{nominal term}},
  kind={key}
}
...
\newglossaryentry{upperwarning key}
{
  ...
  category=model,
  name={UPPER\_WARNING},
  description={\glsentrydesc{upper warning term}},
  kind={key}
}
...
\newglossaryentry{lowerwarning key}
{
  ...
  category=model,
  name={LOWER\_WARNING},
  description={\glsentrydesc{lower warning term}},
  kind={key}
}
...
\newglossaryentry{controllimit event}
{
  ...
  kind={event,type},
  description={\glsentrydesc{control limits term}},
  facet={\gls{float}}
}
...
\newglossaryentry{specificationlimit event}
{
  ...
  kind={event,type},
  description={\glsentrydesc{specification limits term}},
  facet={\gls{float}}
}
...
\newglossaryentry{alarmlimit event}
{
  ...
  kind={event,type},
  description={\glsentrydesc{alarm limits term}},
  facet={\gls{float}}
}
...
\newglossaryentry{solidmodelidref}
{
  type=mtc,
  category=model,
  name={solidModelIdRef},
  kind={attribute},
...
\newglossaryentry{itemref}
{
  ...
  name={itemRef},
  kind={attribute},
  description={The reference to the item within the model within the related geometry. A \gls{solidmodelidref} \MUST be given.}
}
...
\newglossaryentry{scale}
{
  ...
  category=model,
  name={Scale},
  description={The \gls{solidmodel configuration} \gls{scale} is either a single multiplier applied to all three dimensions or a three space multiplier given in the X, Y, and Z dimensions in the coordinate system used for the \gls{solidmodel configuration}.}
}
...
\longnewglossaryentry{raw material}
{
  name={raw material}
}
{
