...
\newglossaryentry{Component}
{
  ...
  \textbf{BEGIN:itemize}
      \textbf{ITEM} When used as an XML container to organize \gls{Lower Level} \block{Component} elements. 
      Appears in the documents in the following form: \block{Components}.
      \textbf{ITEM} When used as an abstract XML element. \block{Component} is replaced in a data model by a type of \gls{Component} element. \block{Component} is also an XML container used to organize \gls{Lower Level} \block{Component} elements, \glspl{Data Entity}, or both.
...
\newglossaryentry{Composition}
{
  ...
  A data modeling element used to organize the data being retrieved from a piece of equipment.
  \textbf{BEGIN:itemize}
      \textbf{ITEM} When used as an XML container to organize \block{Composition} elements. 
      Appears in the documents in the following form: \block{Compositions}
      \textbf{ITEM} When used as an abstract XML element. \block{Composition} is replaced in a data model by a type of \gls{Composition} element. 
...
\newglossaryentry{Condition}
{
    ...
    \textbf{BEGIN:itemize}
	\textbf{ITEM} When used as an XML container to organize \gls{Lower Level} \block{Condition} elements.
	Appears in the documents in the following form: \block{Condition}.
	\textbf{ITEM} When used as a \gls{Lower Level} element, the form \block{Condition} is an abstract type XML element.  This \gls{Lower Level} element is a \gls{Data Entity}.  \block{Condition} is replaced in a data model by type of \gls{Condition} element.
	Appears in the documents in the following form: \block{Condition}.
	\textbf{END:itemize}
	\textbf{BEGIN:note}
...
\newglossaryentry{Current Request}
{
	...
	description={An \textbf{GLSTEXT:http} request to the \gls{Agent} for returning latest known values for the \block{DataItem} as an \block{MTConnectStreams} \textbf{GLSTEXT:xml} document}
}
...
\newglossaryentry{Data Item}
{
    ...
    \textbf{BEGIN:itemize}
	\textbf{ITEM} When used as an XML container to organize \block{DataItem} elements.
	Appears in the documents in the following form: \block{DataItems}.
	\textbf{ITEM} When used to represent a specific \gls{Data Entity}, the form \block{DataItem} is an XML element.  
...
\newglossaryentry{Event}
{
	...
	\textit{ULHEADING:Used as a \block{category} attribute for a \gls{Data Entity}}:
    ...
    \textbf{BEGIN:itemize}
	\textbf{ITEM} When used as an XML container that consists of one or more types of \block{Event} XML elements.
	Appears in the documents in the following form: \block{Events}.
	\textbf{ITEM} When used as an abstract XML element.  It is replaced in the XML document by types of \block{Event} elements.
	Appears in the documents in the following form: \block{Event}.
    \textbf{END:itemize}
}
}
...
\newglossaryentry{Sample}
{
	...
	\textbf{ITEM} When used as an abstract XML element.  It is replaced in the XML document by types of \block{Sample} elements representing individual \gls{Sample} type of \gls{Data Entity}.
	Appears in the documents in the following form: \block{Sample}.
    \textbf{END:itemize}
}
}
...
\newglossaryentry{Device}
{
    ...
    \textbf{BEGIN:itemize}
	\textbf{ITEM} When used as an XML container to organize \block{Device} elements.
...
\newglossaryentry{Interface}
{
	...
	\textbf{ULHEADING:Used as an XML container or element}:
	\textbf{TAB} - When used as an XML container that consists of one or more types of \block{Interface} XML elements.
	Appears in the documents in the following form: \block{Interfaces}.
	\textbf{TAB} - When used as an abstract XML element.  It is replaced in the XML document by types of \block{Interface} elements.
...
{
    name={Probe Request},
	description={An \textbf{GLSTEXT:http} request to the \gls{Agent} for returning metadata as an \block{MTConnectDevices} \textbf{GLSTEXT:xml} document}
}
...
\newglossaryentry{Probe}
{
	...
	The form \block{PROBE} is used to designate a subtype for the \gls{Data Entity} \block{PATH\textunderscore POSITION} indicating a measurement position relating to a probe unit.
	...
	The form \block{probe} is used to designate a \gls{Probe Request} in the \textit{CFONT:<Path>} portion of an \gls{HTTP Request Line}.
	Appears in the documents in the following form: \block{probe}.
    \textbf{END:itemize}
}
}
